    ...
    export default {
        ...
        methods: {
            ...
            found_sno_stu() {
                ...
                this.axios.post(this.$apiUrl +'/mylog/getmylogbyusername', param, {
                    headers: {
            ...
            handleSelectionChange(selection) {
                ...
                this.list = selection.map(item => item.id);
                console.log(selection)
            },

        },
        mounted() {
            this.axios.get(this.$apiUrl +"/mylog/getall", {
                headers: {
