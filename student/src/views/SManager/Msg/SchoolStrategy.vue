    ...
    <div>
        <div class="whole" v-if="flag">
            ...
            <el-table ref="multipleTable" :header-cell-style="{textAlign:'center'}" :cell-style="{textAlign:'center'}" tooltip-effect="dark"
                ...
                <el-table-column type="selection" label="全部" :reserve-selection="true" width="80"></el-table-column>
                <el-table-column prop="title" label="消息" width="508" sortable></el-table-column>
                <el-table-column prop="operation" label="操作" width="200">
                    <template slot-scope="scope">
                        <el-button @click="deTails_one(scope.row)" type="text" icon="el-icon-edit-outline">修改</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    export default {
        ...
        mounted() {
            this.show_one();
            this.$store.commit("setMsgtype","校园攻略");
        },
        // created() {
        ...
        methods: {
            ...
            if(index==1){
                this.$router.push('/main/msgmhome/schoolstrategy/addmsg');
                this.flag=0;
                }else{
                this.$message.error({
                    message: "无该权限！",
            ...
            show_one() {
                ...
                this.axios.get(this.$apiUrl +'/trategy/gettitle', {
                        headers: {
            ...
            if(index==1){
                ...
                this.flag = 0
                this.$router.push({
                    path: '/main/msgmhome/schoolstrategy/message',
                })
                }else{
                this.$message.error({
                    message: "无该权限！",
            ...
            if(index==1){
                ...
                this.$confirm('确定删除该条记录？', '提示', {
                    ...
                    this.axios.post(this.$apiUrl +'/trategy/delete', param, {
                            headers: {
                                'Authorization': localStorage.getItem('token'+this.$store.state.id)
                            }
                        })
        ...
        watch: {
            $route(to){
                if(to.path =='/main/msgmhome/schoolstrategy'){
