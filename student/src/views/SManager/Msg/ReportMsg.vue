...
<script>
    export default {
        ...
        mounted() {
            this.show_one();
            this.$store.commit("setMsgtype","报到须知");
        },
        // created() {
        ...
        methods: {
            ...
            if(index==1){
                this.$router.push('/main/msgmhome/reportmsg/addmsg');
                this.flag=0;
                }else{
                this.$message.error({
                    message: "无该权限！",
            ...
            show_one() {
                ...
                this.axios.get(this.$apiUrl +'/reportnotice/gettitle', {
                        headers: {
            ...
            if(index==1){
                ...
                this.flag = 0
                this.$router.push({
                    path: '/main/msgmhome/reportmsg/message',
                })
                }else{
                this.$message.error({
                    message: "无该权限！",
            ...
            if(index==1){
                ...
                this.$confirm('确定删除该条记录？', '提示', {
                    ...
                    this.axios.post(this.$apiUrl +'/reportnotice/delete', param, {
                            headers: {
                                'Authorization': localStorage.getItem('token'+this.$store.state.id)
                            }
                        })
        ...
        watch: {
            $route(to){
                if(to.path =='/main/msgmhome/reportmsg' ){
