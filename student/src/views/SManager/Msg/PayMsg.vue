...
<script>
    export default {
        ...
        mounted() {
            this.show_one();
            this.$store.commit("setMsgtype", "缴费须知");
        },
        // created() {
        ...
        methods: {
            ...
            toadd() {
                ...
                if (index == 1) {
                    this.$router.push('/main/msgmhome/paymsg/addmsg');
                    this.flag = 0;
                } else {
                    this.$message.error({
                        message: "无该权限！",
            ...
            show_one() {
                ...
                this.axios.get(this.$apiUrl +'/paynotice/gettitle', {
                        headers: {
            ...
            deTails_one(row) {
                ...
                if (index == 1) {
                    ...
                    this.flag = 0
                    this.$router.push({
                        path: '/main/msgmhome/paymsg/message',
                    })
                } else {
                    this.$message.error({
                        message: "无该权限！",
                ...
                if (index == 1) {
                    if (this.notice_one_delete.length === 0) {
                        ...
                        this.$confirm('确定删除该条记录？', '提示', {
                            ...
                            this.axios.post(this.$apiUrl +'/paynotice/delete', param, {
                                    headers: {
        ...
        watch: {
            $route(to) {
                if (to.path == '/main/msgmhome/paymsg') {
