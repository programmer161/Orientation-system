                ...
                <el-aside width="200px">
                    <el-menu  class="el-menu-vertical-demo" 
                        ...
                        @close="handleClose"
                         ...
                         <el-menu-item v-for="(data,index) in list" :key="index"   @click="tostate(data.frontendMenuUrl)" :class="(data.frontendMenuId==24||data.frontendMenuId==25 ||data.frontendMenuId==28 ||data.frontendMenuId==31)?'el':'None'">
