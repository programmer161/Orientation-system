...
import com.Digital_Orientation_System.components.DynamicPermission;
...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/message/gettitle").permitAll()
                .antMatchers(HttpMethod.POST,"/message/getvalues").permitAll()
                .antMatchers(HttpMethod.GET,"/paynotice/gettitle").permitAll()
                .antMatchers(HttpMethod.POST,"/paynotice/getvalues").permitAll()
                .antMatchers(HttpMethod.GET,"/reportnotice/gettitle").permitAll()
                .antMatchers(HttpMethod.POST,"/reportnotice/getvalues").permitAll()
                .antMatchers(HttpMethod.GET,"/trategy/gettitle").permitAll()
                .antMatchers(HttpMethod.POST,"/trategy/getvalues").permitAll()
                .antMatchers(HttpMethod.POST,"/users/findsno").permitAll()
                .antMatchers(HttpMethod.GET,"/getpwd/getcode").permitAll()
                .antMatchers(HttpMethod.POST,"/getpwd/updatepwd").permitAll()
                //ROLE_ADMIN可以操作任何事情
