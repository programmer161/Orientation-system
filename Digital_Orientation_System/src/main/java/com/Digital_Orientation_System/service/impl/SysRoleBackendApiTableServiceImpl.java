...
import com.Digital_Orientation_System.dao.SysRoleBackendApiTableDao;
...
public class SysRoleBackendApiTableServiceImpl extends ServiceImpl<SysRoleBackendApiTableDao, SysRoleBackendApiTable> implements SysRoleBackendApiTableService {
    @Autowired
    SysRoleBackendApiTableDao sysRoleFrontendApiTableDao;
    /**
     * 批量保存角色-API表
    ...
    @Override
    public void saveRoleApi(String roleId) {
        sysRoleFrontendApiTableDao.saveRoleApi(roleId);
    }
}